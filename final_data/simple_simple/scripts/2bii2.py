...
for csv in csvs:
    ...
    ax.legend()
    ax.legend(facecolor=color_values[random.randint(0, len(color_values) - 1)])

    fig.tight_layout()
    plt.savefig(os.path.join('../plots/2bii2', csv.replace('.csv', '.png')))
    plt.close()